...
1. **ZigZag 趨勢識別**：
   - 當市場出現 **一段下跌** 或趨勢變化時，透過 ZigZag 方法識別重要的價格轉折點。
   
2. **模板繪圖**：
   - 在識別的趨勢基礎上，繪製 **3x4 矩形框架**（共 12 格）來劃分價格區域：
     - **綠色區域**：禁止有 K 線出現。
     - **紅色區域**：需要有 K 線出現。
     - **灰色區域**：可有可無的 K 線。

3. **信號觸發**：
   - 根據模板比對法，搭配以下進場條件進行交易：
     - **標準圖**：滿足多空模板結構的條件。
     - **拉回買進**：趨勢方向的回撤中捕捉機會。
     - **Swimming**：利用 ZigZag 偵測類似游泳的波動模式進行進場。
  
---
## 範例1
<p align="center">
  <img src="./範例1.png" alt="策略示意圖" width="800">
</p>
...
## 範例2
<p align="center">
  <img src="./範例2.png" alt="策略示意圖" width="800">
</p>
...
## 範例3
<p align="center">
  <img src="./範例3.png" alt="策略示意圖" width="800">
</p>
